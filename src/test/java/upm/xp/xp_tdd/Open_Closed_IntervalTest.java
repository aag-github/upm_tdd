...
import upm.xp.xp_tdd.IntersectionBaseTest.TestName;

@RunWith(Parameterized.class)
public class Open_Closed_IntervalTest extends IntersectionBaseTest {

    @Parameters(name = "{index}: Open_Closed: {0} {1}{2},{3}{4} {5}{6},{7}{8} returns {9}") 
    public static Collection<Object[]> data() {
        Object[][] values = {               
                ...
                { TestName.ZeroLength_InTheMiddle,             "(", 4, 6, ")", "[", 5, 5, "]", true },
